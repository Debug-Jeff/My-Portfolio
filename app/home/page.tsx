...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        >
          <div className="w-full h-full rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center overflow-hidden">
            ...
            <div className="w-full h-full bg-gradient-to-br from-muted/50 to-muted-foreground/50 rounded-full flex items-center justify-center">
      ...
      {/* Gradient Overlays */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 via-transparent to-purple-900/20 dark:from-blue-900/20 dark:via-transparent dark:to-purple-900/20 pointer-events-none"></div>
      ...
      <main className="relative z-10 flex-grow container mx-auto py-24 px-4 mt-16">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 min-h-[calc(100vh-200px)]">
          ...
          >
            <div className="bg-card/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-2xl p-6 w-full max-w-lg relative overflow-hidden">
              {/* Terminal Header */}
